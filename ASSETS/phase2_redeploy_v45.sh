#!/usr/bin/env bash
# Phase 2 Production Re-Deploy Card v4.5 — Fail-Closed Single Orchestrator (ro-safe, single H6)
set -Eeuo pipefail
...
# (NO second H6 — restore wipes all dry-run fixtures, manifest must equal pre-cutover)
